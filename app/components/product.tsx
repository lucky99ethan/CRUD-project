  ...
  return (
    <div className="mt-10">
      <div className="flex mb-4 justify-center items-center">
        <select value={selectedCategory} onChange={handleCategoryChange} className="p-2 border select select-primary rounded mr-2 w-40">
            ...
            {filteredData.map(item => (
              <tr key={item.id} className="border-b border-gray-400">
                ...
                <td className="px-4 py-2">
                  <button onClick={() => handleEditItem(item.id)} className="btn btn-primary mr-2">
                    <AiTwotoneEdit />
                  </button>
                  <button onClick={() => handleDeleteItem(item.id)} className="btn btn-primary">
                    <AiOutlineDelete />
                  </button>
                </td>
              </tr>
